...
const ru: LANG_MESSAGE = {
  ...
  trafficCancel: 'Отмена',
  trafficRollingTimeRanges: 'Последние периоды',
  trafficCalendarTimeRanges: 'Календарные периоды',
  ...
  trafficLast6Hours: 'Последние 6 часов',
  ...
  trafficYesterday: 'Вчера',
  trafficThisWeek: 'Эта неделя',
  trafficThisMonth: 'Этот месяц',
  trafficLastMonth: 'Прошлый месяц',
  trafficLogicalPayload: 'Полезная нагрузка',
  trafficMetricScopeDetails: 'Как считается статистика',
  trafficMetricScopeHint:
    'Учитывается полезная нагрузка соединений, а не весь трафик интерфейса; накладные расходы протокола не включены. Число соединений — сохранённые соединения/сеансы, а не активные сейчас.',
  trafficActualRange: 'Фактический период: {from} – {to}',
  trafficRoutePath: 'Маршрут / группы → исходящий узел',
  trafficNetwork: 'Сеть',
  trafficFlows: 'Число соединений',
  trafficLoadFailed: 'Не удалось загрузить статистику трафика.',
  trafficGrouping: 'Группировка',
  trafficGroupByOption: 'Группировать по: {dimension}',
  trafficGroupRoutePath: 'Маршрут',
  trafficGroupRoutePathDescription:
    'Показывает, куда направлен трафик, путь через группы прокси и выбранный конечный исходящий узел. TCP/UDP и разные версии конфигурации считаются отдельно.',
  trafficGroupRoutePathCount: 'Записи маршрутизации',
  trafficGroupDestination: 'Целевой хост',
  trafficGroupDestinationDescription:
    'Группирует по целевому хосту: по возможности используется домен, иначе целевой IP. Это не адрес прокси-сервера.',
  trafficGroupDestinationCount: 'Целевые хосты',
  trafficGroupDestinationDomain: 'Целевой домен',
  trafficGroupOutboundGroup: 'Группа прокси',
  trafficGroupOutboundGroupDescription:
    'Группирует по группе прокси, которая в итоге выбрала исходящий узел. Для вложенных групп используется самая внутренняя; при прямом выборе узла группы нет.',
  trafficGroupOutboundGroupCount: 'Группы прокси',
  trafficGroupActualOutbound: 'Исходящий узел',
  trafficGroupActualOutboundDescription:
    'Группирует по тегу конечного исходящего узла, выбранного для передачи соединения. direct и другие исходящие учитываются отдельно.',
  trafficGroupActualOutboundCount: 'Исходящие узлы',
  trafficResultsBy: 'Результаты по измерению «{dimension}»',
  trafficResultCount: 'Результатов: {count}',
  trafficSearch: 'Поиск в статистике трафика',
  trafficSearchPlaceholder: 'Поиск по выбранному измерению',
  trafficSearchRoutePath: 'Поиск маршрутов',
  trafficSearchDestination: 'Поиск целевых хостов',
  trafficSearchOutboundGroup: 'Поиск групп прокси',
  trafficSearchActualOutbound: 'Поиск исходящих узлов',
  trafficClearSearch: 'Очистить поиск',
  trafficFilterAndSort: 'Фильтры и сортировка',
  trafficActiveConditions: 'Активных условий: {count}',
  trafficMoreConditions: 'Ещё {count}',
  trafficCommonFilters: 'Основные настройки',
  ...
  trafficShareOfTotal: 'Доля общего трафика',
  trafficDestinationAvailableFrom:
    'Подробные данные о целевых хостах полностью записываются с {time}; более ранний трафик не входит в эту выборку.',
  trafficDomainAvailableFrom: 'Данные доменов доступны с {time}.',
  trafficNoRoutePath: 'Нет маршрута',
  trafficNoDestination: 'Нет назначения или не распознано',
  trafficNoDestinationDomain: 'Нет домена или не распознан',
  trafficNoOutboundGroup: 'Нет группы политик',
  ...
  trafficDestinationTypeDomain: 'Домен',
  trafficDestinationTypeIP: 'IP',
  trafficExactFilters: 'Расширенные точные фильтры',
  trafficExactFiltersHint:
    'В каждом поле можно указать несколько допустимых значений; при заполнении нескольких полей результат должен соответствовать каждому из них.',
  trafficRouteTagFilter: 'Тег сработавшего маршрута',
  trafficRouteTagFilterPlaceholder: 'Введите точный тег маршрута',
  trafficGroupTagFilter: 'Тег самой внутренней группы прокси',
  trafficGroupTagFilterPlaceholder: 'Введите точный тег группы',
  trafficActualOutboundTagFilter: 'Тег фактического исходящего узла',
  trafficActualOutboundTagFilterPlaceholder: 'Введите точный тег узла',
  trafficDestinationFilter: 'Целевой хост (домен/IP)',
  trafficDestinationFilterPlaceholder: 'Введите точный домен или IP',
  trafficRouteSelected: 'Направлено в',
  trafficGroupPath: 'Путь через группы прокси',
  trafficOutboundType: 'Тип исходящего узла',
  trafficConfigRevision: 'Версия конфигурации',
  trafficExactValueHint: 'Нажмите Enter, чтобы добавить точное значение.',
  trafficExactValueTooMany: 'В каждом поле допускается не более 256 точных значений.',
  ...
  trafficRemoveCondition: 'Удалить {label}: {value}',
