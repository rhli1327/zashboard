...
const ru: LANG_MESSAGE = {
  ...
  trafficGroupDestination: 'Назначение (домен/IP)',
  ...
  trafficDestinationAvailableFrom: 'Данные назначений доступны с {time}.',
  ...
  trafficExactFilters: 'Точные фильтры',
  trafficExactFiltersHint: 'Значения одного поля объединяются по ИЛИ, разные поля — по И.',
  trafficRouteTagFilter: 'Тег маршрута',
  trafficRouteTagFilterPlaceholder: 'Введите точный тег маршрута',
  trafficGroupTagFilter: 'Тег конечной группы',
  trafficGroupTagFilterPlaceholder: 'Введите точный тег группы',
  trafficActualOutboundTagFilter: 'Тег исходящего узла',
  trafficActualOutboundTagFilterPlaceholder: 'Введите точный тег узла',
  trafficDestinationFilter: 'Домен/IP назначения',
