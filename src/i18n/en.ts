const en = {
  ...
  trafficGroupDestination: 'Destination (domain/IP)',
  ...
  trafficDestinationAvailableFrom: 'Destination data is available from {time}.',
  ...
  trafficExactFilters: 'Exact filters',
  trafficExactFiltersHint: 'Values in the same field use OR; different fields use AND.',
  trafficRouteTagFilter: 'Route tag',
  trafficRouteTagFilterPlaceholder: 'Enter an exact route tag',
  trafficGroupTagFilter: 'Final outbound group tag',
  trafficGroupTagFilterPlaceholder: 'Enter an exact group tag',
  trafficActualOutboundTagFilter: 'Outbound node tag',
  trafficActualOutboundTagFilterPlaceholder: 'Enter an exact node tag',
  trafficDestinationFilter: 'Destination domain/IP',
