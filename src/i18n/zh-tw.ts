...
const zhTW: LANG_MESSAGE = {
  ...
  trafficStatisticsDescription:
    '依分流路徑、目標主機、策略組或出站節點，查看伺服器保留的上傳、下載與連線次數。',
  trafficTimeRange: '時間範圍',
  trafficSelectTimeRange: '選擇時間範圍',
  trafficCustomTimeRange: '自訂範圍',
  trafficTimeRangeStart: '開始時間',
  trafficTimeRangeEnd: '結束時間',
  trafficApplyTimeRange: '套用時間範圍',
  trafficInvalidTimeRange: '請選擇有效且不晚於目前時間的範圍。',
  trafficTimeRangeHint: '僅統計伺服器保留期內的資料。',
  trafficAllRetained: '全部保留資料',
  trafficLastHour: '最近 1 小時',
  trafficLast24Hours: '最近 24 小時',
  trafficLast7Days: '最近 7 天',
  trafficLast30Days: '最近 30 天',
  trafficLogicalPayload: '邏輯負載',
  trafficMetricScopeDetails: '統計口徑',
  trafficMetricScopeHint:
    '流量是連線的邏輯負載，不是網路介面總流量，也不含協定傳輸開銷；連線次數是保留期內的連線或工作階段數，不是目前在線數。',
  trafficActualRange: '實際統計：{from} – {to}',
  trafficRoutePath: '分流 / 策略組路徑 → 出站節點',
  trafficNetwork: '網路',
  trafficFlows: '連線次數',
  trafficLoadFailed: '載入流量統計失敗。',
  trafficGrouping: '彙總方式',
  trafficGroupByOption: '依{dimension}統計',
  trafficGroupRoutePath: '分流路徑',
  trafficGroupRoutePathDescription:
    '顯示流量被分到哪裡、經過的策略組路徑和最終選擇的出站節點；TCP/UDP 或不同設定版本會分開統計。',
  trafficGroupRoutePathCount: '分流記錄數',
  trafficGroupDestination: '目標主機',
  trafficGroupDestinationDescription:
    '依目標主機彙總；優先使用網域，無法識別網域時改用目標 IP。這不是代理伺服器位址。',
  trafficGroupDestinationCount: '目標主機數',
  trafficGroupDestinationDomain: '目標網域',
  trafficGroupOutboundGroup: '策略組',
  trafficGroupOutboundGroupDescription:
    '依最終選擇出站節點的策略組彙總；存在巢狀策略組時取最內層，直接分流到節點時沒有策略組。',
  trafficGroupOutboundGroupCount: '策略組數',
  trafficGroupActualOutbound: '出站節點',
  trafficGroupActualOutboundDescription:
    '依連線最終選擇並分派到的出站節點 tag 彙總；direct 等不同出站會單獨統計。',
  trafficGroupActualOutboundCount: '出站節點數',
  trafficResultsBy: '依{dimension}統計',
  trafficResultCount: '{count} 項結果',
  trafficSearch: '搜尋流量統計',
  trafficSearchPlaceholder: '搜尋目前彙總維度',
  trafficSearchRoutePath: '搜尋分流路徑',
  trafficSearchDestination: '搜尋目標主機',
  trafficSearchOutboundGroup: '搜尋策略組',
  trafficSearchActualOutbound: '搜尋出站節點',
  trafficClearSearch: '清除搜尋',
  trafficFilterAndSort: '篩選與排序',
  trafficActiveConditions: '已啟用 {count} 個條件',
  trafficMoreConditions: '另有 {count} 個',
  trafficCommonFilters: '常用設定',
  trafficNetworkFilter: '依網路篩選',
  trafficAllNetworks: '全部網路',
  trafficPageSize: '每頁列數',
  trafficRowsPerPage: '每頁 {count} 筆',
  trafficTotalTraffic: '總流量',
  trafficShareOfTotal: '占本次總流量',
  trafficDestinationAvailableFrom: '目標主機明細自 {time} 起完整記錄；本次統計不包含此前流量。',
  trafficDomainAvailableFrom: '網域資料自 {time} 起可用。',
  trafficNoRoutePath: '無分流路徑',
  trafficNoDestination: '無目標或未識別',
  trafficNoDestinationDomain: '無網域或未識別',
  trafficNoOutboundGroup: '無策略組',
  ...
  trafficPreviousPage: '上一頁',
  trafficNextPage: '下一頁',
  trafficPageStatus: '第 {page} / {pages} 頁',
  trafficDestinationTypeDomain: '網域',
  trafficDestinationTypeIP: 'IP',
  trafficExactFilters: '進階精確篩選',
  trafficExactFiltersHint: '同一項可加入多個候選值；填寫多項篩選時，結果需同時符合。',
  trafficRouteTagFilter: '分流到的 tag',
  trafficRouteTagFilterPlaceholder: '輸入準確的分流 tag',
  trafficGroupTagFilter: '最內層策略組 tag',
  trafficGroupTagFilterPlaceholder: '輸入準確的最內層策略組 tag',
  trafficActualOutboundTagFilter: '實際出站節點 tag',
  trafficActualOutboundTagFilterPlaceholder: '輸入準確的節點 tag',
  trafficDestinationFilter: '目標主機（網域/IP）',
  trafficDestinationFilterPlaceholder: '輸入準確的目標網域或 IP',
  trafficRouteSelected: '分流到',
  trafficGroupPath: '策略組路徑',
  trafficOutboundType: '出站類型',
  trafficConfigRevision: '設定版本',
  trafficExactValueHint: '按 Enter 新增精確值。',
  trafficExactValueTooMany: '每個欄位最多可新增 256 個精確值。',
