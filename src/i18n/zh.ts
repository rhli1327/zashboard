...
const zh: LANG_MESSAGE = {
  ...
  // 服务端流量统计
  trafficStatisticsDescription: '由服务端保留的逻辑载荷，按所选维度聚合和筛选。',
  ...
  trafficGroupDestination: '目标（域名/IP）',
  trafficGroupDestinationDomain: '目标域名',
  trafficGroupOutboundGroup: '节点组',
  trafficGroupActualOutbound: '节点',
  ...
  trafficDestinationAvailableFrom: '目标数据自 {time} 起可用。',
  ...
  trafficExactFilters: '精确筛选',
  trafficExactFiltersHint: '同一字段内匹配任一值，不同字段之间同时满足。',
  trafficRouteTagFilter: '分流 tag',
  trafficRouteTagFilterPlaceholder: '输入准确的分流 tag',
  trafficGroupTagFilter: '最终节点组 tag',
  trafficGroupTagFilterPlaceholder: '输入准确的节点组 tag',
  trafficActualOutboundTagFilter: '出站节点 tag',
  trafficActualOutboundTagFilterPlaceholder: '输入准确的节点 tag',
  trafficDestinationFilter: '目标域名/IP',
  trafficDestinationFilterPlaceholder: '输入准确的域名或 IP',
