...
const zh: LANG_MESSAGE = {
  ...
  trafficStatisticsDescription:
    '按分流路径、目标主机、策略组或出站节点，查看服务端保留的上传、下载和连接次数。',
  trafficTimeRange: '时间范围',
  trafficSelectTimeRange: '选择时间范围',
  trafficCustomTimeRange: '自定义范围',
  trafficTimeRangeStart: '开始时间',
  trafficTimeRangeEnd: '结束时间',
  trafficApplyTimeRange: '应用时间范围',
  trafficInvalidTimeRange: '请选择有效且不晚于当前时间的范围。',
  trafficTimeRangeHint: '仅统计服务端保留期内的数据。',
  trafficAllRetained: '全部保留数据',
  trafficLastHour: '最近 1 小时',
  trafficLast24Hours: '最近 24 小时',
  trafficLast7Days: '最近 7 天',
  trafficLast30Days: '最近 30 天',
  trafficLogicalPayload: '逻辑载荷',
  trafficMetricScopeDetails: '统计口径',
  trafficMetricScopeHint:
    '流量是连接的逻辑载荷，不是网卡总流量，也不含协议传输开销；连接次数是保留期内的连接或会话数，不是当前在线数。',
  trafficActualRange: '实际统计：{from} – {to}',
  trafficRoutePath: '分流 / 策略组路径 → 出站节点',
  trafficNetwork: '网络',
  trafficFlows: '连接次数',
  trafficLoadFailed: '加载流量统计失败。',
  trafficGrouping: '聚合方式',
  trafficGroupByOption: '按{dimension}统计',
  trafficGroupRoutePath: '分流路径',
  trafficGroupRoutePathDescription:
    '展示流量被分到哪里、经过的策略组路径和最终选择的出站节点；TCP/UDP 或不同配置版本会分开统计。',
  trafficGroupRoutePathCount: '分流记录数',
  trafficGroupDestination: '目标主机',
  trafficGroupDestinationDescription:
    '按目标主机汇总；优先使用域名，无法识别域名时回退到目标 IP。这里不是代理服务器地址。',
  trafficGroupDestinationCount: '目标主机数',
  trafficGroupDestinationDomain: '目标域名',
  trafficGroupOutboundGroup: '策略组',
  trafficGroupOutboundGroupDescription:
    '按最终选择出站节点的策略组汇总；存在嵌套策略组时取最内层，直接分流到节点时没有策略组。',
  trafficGroupOutboundGroupCount: '策略组数',
  trafficGroupActualOutbound: '出站节点',
  trafficGroupActualOutboundDescription:
    '按连接最终选择并分派到的出站节点 tag 汇总；direct 等不同出站会单独统计。',
  trafficGroupActualOutboundCount: '出站节点数',
  trafficResultsBy: '按{dimension}统计',
  trafficResultCount: '{count} 项结果',
  trafficSearch: '搜索流量统计',
  trafficSearchPlaceholder: '搜索当前聚合维度',
  trafficSearchRoutePath: '搜索分流路径',
  trafficSearchDestination: '搜索目标主机',
  trafficSearchOutboundGroup: '搜索策略组',
  trafficSearchActualOutbound: '搜索出站节点',
  trafficClearSearch: '清除搜索',
  trafficFilterAndSort: '筛选与排序',
  trafficActiveConditions: '已启用 {count} 个条件',
  trafficMoreConditions: '另有 {count} 个',
  trafficCommonFilters: '常用设置',
  trafficNetworkFilter: '按网络筛选',
  trafficAllNetworks: '全部网络',
  trafficPageSize: '每页行数',
  trafficRowsPerPage: '每页 {count} 条',
  trafficTotalTraffic: '总流量',
  trafficShareOfTotal: '占本次总流量',
  trafficDestinationAvailableFrom: '目标主机明细自 {time} 起完整记录；本次统计不包含此前流量。',
  trafficDomainAvailableFrom: '域名数据自 {time} 起可用。',
  trafficNoRoutePath: '无分流路径',
  trafficNoDestination: '无目标或未识别',
  trafficNoDestinationDomain: '无域名或未识别',
  trafficNoOutboundGroup: '无策略组',
  ...
  trafficPreviousPage: '上一页',
  trafficNextPage: '下一页',
  trafficPageStatus: '第 {page} / {pages} 页',
  trafficDestinationTypeDomain: '域名',
  trafficDestinationTypeIP: 'IP',
  trafficExactFilters: '高级精确筛选',
  trafficExactFiltersHint: '同一项可添加多个候选值；填写多项筛选时，结果需同时符合。',
  trafficRouteTagFilter: '分流到的 tag',
  trafficRouteTagFilterPlaceholder: '输入准确的分流 tag',
  trafficGroupTagFilter: '最内层策略组 tag',
  trafficGroupTagFilterPlaceholder: '输入准确的最内层策略组 tag',
  trafficActualOutboundTagFilter: '实际出站节点 tag',
  trafficActualOutboundTagFilterPlaceholder: '输入准确的节点 tag',
  trafficDestinationFilter: '目标主机（域名/IP）',
  trafficDestinationFilterPlaceholder: '输入准确的目标域名或 IP',
  trafficRouteSelected: '分流到',
  trafficGroupPath: '策略组路径',
  trafficOutboundType: '出站类型',
  trafficConfigRevision: '配置版本',
  trafficExactValueHint: '按 Enter 添加精确值。',
  trafficExactValueTooMany: '每个字段最多可添加 256 个精确值。',
  trafficExactValueTooLong: '每个精确值最多为 1024 个 UTF-8 字节。',
  trafficRemoveExactValue: '移除精确值',
  trafficRemoveCondition: '移除{label}：{value}',
